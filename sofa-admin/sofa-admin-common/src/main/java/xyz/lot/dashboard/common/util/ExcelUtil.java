...
import xyz.lot.common.annotation.Excels;
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (StringUtils.endsWith(s, ".0")) {
                            ...
                            {
                                val = xyz.lot.common.util.DateUtil.parseDateToStr(dateFormat, (Date) val);
                            }
                            else
                            {
                        ...
                        if (val instanceof String) {
                            val = xyz.lot.common.util.DateUtil.parseDate(val);
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                {
                    cell.setCellValue(xyz.lot.common.util.DateUtil.parseDateToStr(dateFormat, (Date) value));
                }
