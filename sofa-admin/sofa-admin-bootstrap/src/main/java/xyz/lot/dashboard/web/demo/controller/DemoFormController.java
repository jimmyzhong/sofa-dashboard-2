...
public class DemoFormController {
    ...
    @ResponseBody
    @AjaxWrapper
    public PageModel userModel() {
        return PageModel.instance(users.size(), users);
    }
    ...
    @ResponseBody
    public PageModel collection() {
        String[] array = {"ruoyi 1", "ruoyi 2", "ruoyi 3", "ruoyi 4", "ruoyi 5"};
        return PageModel.instance(array.length, Arrays.asList(array));
    }
}
